...
class ReportDebit(models.Model):
    _name = 'report.debit'
    ...
    code = fields.Char("Mã khách/NCC")
    name = fields.Char("Tên khách/NCC")
    tk = fields.Char("TK")
    first_debit = fields.Float('Nợ đầu kỳ')
    first_credit = fields.Float('Có đầu kỳ')
    debt = fields.Float("PS nợ")
    credit = fields.Float("PS có")
    last_debit = fields.Float("Nợ cuối kỳ")
    last_credit = fields.Float("Có cuối kỳ")
    partner_id = fields.Many2one('res.partner', string='Tên khách hàng/NCC')
