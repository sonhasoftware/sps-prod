odoo.define('web.searchUtils', function (require) {
    ...
    const MONTH_OPTIONS = {
        ...
        three_months_ago: {
            id: 'three_months_ago', groupNumber: 1, format: 'MMMM',
            addParam: {months: -3}, granularity: 'month',
        },
        four_months_ago: {
            id: 'four_months_ago', groupNumber: 1, format: 'MMMM',
            addParam: {months: -4}, granularity: 'month',
        },
        five_months_ago: {
            id: 'five_months_ago', groupNumber: 1, format: 'MMMM',
            addParam: {months: -5}, granularity: 'month',
        },
        six_months_ago: {
            id: 'six_months_ago', groupNumber: 1, format: 'MMMM',
            addParam: {months: -6}, granularity: 'month',
        },
        seven_months_ago: {
            id: 'seven_months_ago', groupNumber: 1, format: 'MMMM',
            addParam: {months: -7}, granularity: 'month',
        },
        eight_months_ago: {
            id: 'eight_months_ago', groupNumber: 1, format: 'MMMM',
            addParam: {months: -8}, granularity: 'month',
        },
        nine_months_ago: {
            id: 'nine_months_ago', groupNumber: 1, format: 'MMMM',
            addParam: {months: -9}, granularity: 'month',
        },
        ten_months_ago: {
            id: 'ten_months_ago', groupNumber: 1, format: 'MMMM',
            addParam: {months: -10}, granularity: 'month',
        },
        eleven_months_ago: {
            id: 'eleven_months_ago', groupNumber: 1, format: 'MMMM',
    ...
    const YEAR_OPTIONS = {
        ...
        three_months_year: {
            id: 'three_months_year', groupNumber: 2, format: 'YYYY',
            addParam: {years: -3}, granularity: 'year',
        }
    };
